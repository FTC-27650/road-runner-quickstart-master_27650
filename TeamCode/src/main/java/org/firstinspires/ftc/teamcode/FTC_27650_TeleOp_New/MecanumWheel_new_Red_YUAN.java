...
@TeleOp(name = "手动27650_new_red_远", group = "LinearOpmode")
@Config
//@Disabled
public class MecanumWheel_new_Red_YUAN extends LinearOpMode {
    ...
    public static volatile double TurretTargetAngle_jin_1 = -3;//-3    往右为负，往左为正
    public static volatile double TurretTargetAngle_jin_2 = -3;//-3    往右为负，往左为正
    ...
    double x = 50.05, y = 18.90, initialHeading = 90; // 单位厘米 初始化位置
