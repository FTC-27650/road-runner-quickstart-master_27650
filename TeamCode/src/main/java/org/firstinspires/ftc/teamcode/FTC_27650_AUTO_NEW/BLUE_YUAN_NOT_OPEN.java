...
public class BLUE_YUAN_NOT_OPEN extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectoryActionBuilder she_0 = drive.actionBuilder(initialPose)
                .strafeToLinearHeading(new Vector2d(57.05, -18.90), Math.toRadians(200));

        TrajectoryActionBuilder xi_1 = drive.actionBuilder(new Pose2d(57.05, -18.90, Math.toRadians(200)))
                //.strafeToLinearHeading(new Vector2d(58.13, -19.65), Math.toRadians(270))
                .strafeToLinearHeading(new Vector2d(62.96, -50.64), Math.toRadians(270))
                .waitSeconds(0.2)
        ...
        TrajectoryActionBuilder xi_2 = drive.actionBuilder(new Pose2d(57.05, -18.90, Math.toRadians(200)))
                .strafeToLinearHeading(new Vector2d(62.96, -50.64), Math.toRadians(270))
                .waitSeconds(0.2)
                .lineToY(-55.3405, new TranslationalVelConstraint(20))
                .waitSeconds(0.2)
        ...
        TrajectoryActionBuilder she_2 = drive.actionBuilder(new Pose2d(62.96, -55.3405, Math.toRadians(270)))
                .strafeToLinearHeading(new Vector2d(57.05, -18.90), Math.toRadians(200));

        TrajectoryActionBuilder StopPosition = drive.actionBuilder(new Pose2d(57.05, -18.90, Math.toRadians(200)))
                .strafeToLinearHeading(new Vector2d(62.96, -50.64), Math.toRadians(270));
