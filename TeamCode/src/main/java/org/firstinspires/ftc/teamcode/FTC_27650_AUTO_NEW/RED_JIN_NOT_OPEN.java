...
//@TeleOp(name = "BLUE近点_不开闸_排9颗", group = "LinearOpmode")
@Autonomous(name = "RED近点_不开闸_排9颗", group = "LinearOpmode")
@Config
//@Disabled
public class RED_JIN_NOT_OPEN extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Pose2d initialPose = new Pose2d(-51.4373, 47.0373, Math.toRadians(129));
        MecanumDrive drive = new MecanumDrive(hardwareMap, initialPose);
        // actionBuilder 从传递给它的驱动器步骤构建
        TrajectoryActionBuilder she_0 = drive.actionBuilder(initialPose)
                .strafeToLinearHeading(new Vector2d(-39.6406, 11.5553), Math.toRadians(127.24));

        TrajectoryActionBuilder xi_1 = drive.actionBuilder(new Pose2d(-39.6406, 11.5553, Math.toRadians(127.24)))
                .strafeToLinearHeading(new Vector2d(-11.0, 26.3893), Math.toRadians(90))
                .waitSeconds(0.1)
                .lineToY(51.3405, new TranslationalVelConstraint(20));
        //.splineTo(new Vector2d(-11,-51.3405), Math.toRadians(270),
        //new TranslationalVelConstraint(20));

        TrajectoryActionBuilder she_1 = drive.actionBuilder(new Pose2d(-11, 51.3405, Math.toRadians(90)))
                .strafeToLinearHeading(new Vector2d(-17.72, 26.43), Math.toRadians(90));

        TrajectoryActionBuilder xi_2 = drive.actionBuilder(new Pose2d(-17.72, 26.43, Math.toRadians(90)))
                .strafeToLinearHeading(new Vector2d(13.5437, 25.0222), Math.toRadians(90))
                .waitSeconds(0.1)
        ...
        TrajectoryActionBuilder she_2 = drive.actionBuilder(new Pose2d(13.5437, 59.0222, Math.toRadians(90)))
                .strafeToLinearHeading(new Vector2d(14.5437, 35.43), Math.toRadians(90))
                .strafeToLinearHeading(new Vector2d(-17.72, 26.43), Math.toRadians(90));

        TrajectoryActionBuilder StopPosition = drive.actionBuilder(new Pose2d(-17.72, 26.43, Math.toRadians(90)))
                .strafeToLinearHeading(new Vector2d(0, 47.2138), Math.toRadians(90));
