...
@TeleOp(name = "手动27650_new_blue_远", group = "LinearOpmode")
@Config
//@Disabled
public class MecanumWheel_new_blue_YUAN extends LinearOpMode {
    ...
    double x = 45, y = -18.90, initialHeading = -90; // 单位厘米 初始化位置
