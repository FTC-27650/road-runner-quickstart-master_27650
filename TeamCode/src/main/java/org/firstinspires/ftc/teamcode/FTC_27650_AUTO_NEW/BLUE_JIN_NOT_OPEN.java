...
@Autonomous(name = "BLUE近点_不开闸_排9颗", group = "LinearOpmode")
@Config
//@Disabled
public class BLUE_JIN_NOT_OPEN extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectoryActionBuilder xi_1 = drive.actionBuilder(new Pose2d(-39.6406, -11.5553, Math.toRadians(232.77)))
                .strafeToLinearHeading(new Vector2d(-11.0, -26.3893), Math.toRadians(270))
                .waitSeconds(0.1)
                .lineToY(-51.3405, new TranslationalVelConstraint(20));
        //.splineTo(new Vector2d(-11,-51.3405), Math.toRadians(270),
        //new TranslationalVelConstraint(20));

        TrajectoryActionBuilder she_1 = drive.actionBuilder(new Pose2d(-11, -51.3405, Math.toRadians(270)))
